...
(function () {
  ...
  function mount() {
    ...
    tab.style.cssText = 'position:fixed;right:0;top:45%;z-index:55;width:26px;height:52px;border:1px solid var(--line,rgba(255,255,255,.12));border-right:none;'
      + 'border-radius:10px 0 0 10px;background:var(--panel,rgba(18,22,31,.92));color:var(--muted,#8a8fa0);font-size:14px;cursor:pointer;';
  ...
  function rowHtml(s) {
    const color = s.live ? 'var(--warn,#f59e0b)' : s.recent ? 'var(--cream,#e8e4da)' : 'var(--muted,#70758a)';
